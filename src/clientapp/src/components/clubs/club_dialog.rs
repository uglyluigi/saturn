...
impl Component for ClubDialog {
    ...
    fn create(props: Self::Properties, link: ComponentLink<Self>) -> Self {
        Self { link, club_name_field_contents: None, club_body_field_contents: None, props }
    }
    ...
    fn view(&self) -> Html {
        let close_cb = self.props.parent_link.callback(move |e:MouseEvent| {
            crate::components::club_view::Msg::HideDialog
        });
