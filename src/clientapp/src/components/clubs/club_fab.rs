...
use yew::{Callback, Component, ComponentLink, Html, ShouldRender, html};
use yew::Properties;
...
impl Component for CreateClubFloatingActionButton {
    ...
    fn view(&self) -> Html {
        let dialog_open_cb = self.props.parent_link.callback(|_:MouseEvent| {
            crate::components::club_view::Msg::ShowDialog
        });
